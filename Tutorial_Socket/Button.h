...
public:
	...
	HRESULT Initialize(ID3D11Device* pDevice, const wchar_t* idleTexturePath, const wchar_t* hoverTexturePath, const wchar_t* pressedTexturePath, XMFLOAT3 position, XMFLOAT3 scale, UINT align)
	{
		HRESULT result;
